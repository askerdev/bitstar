...
func TestFullParse(t *testing.T) {
	tests := []struct {
		...
		{input: " - negated ", ast: "filter{expression{sequence{factor{term{simple{restriction{comparable{member{value{\"-\"}}}}}}},factor{term{simple{restriction{comparable{member{value{\"negated\"}}}}}}}}}}"},
